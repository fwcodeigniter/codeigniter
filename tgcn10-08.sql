...
--
-- Host: localhost
-- Generation Time: Aug 10, 2017 at 05:36 PM
...
INSERT INTO `product` (`id_product`, `name`, `description`, `price`, `cat_id`, `brand_id`, `image`, `inventory`, `sold`, `created`) VALUES
...
INSERT INTO `user` (`id_user`, `name`, `pass`, `dname`, `phone`, `email`, `permission`) VALUES
